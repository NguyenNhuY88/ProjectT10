...
//    TextView mBarcodeTextView, mDownloadUriTexView;
...
//
//        mDownloadUriTexView = (TextView) findViewById(R.id.tv_url);
//    }
//
//    @Override
...
////        });
//        showProgressBar();
//        uploadTask.addOnCompleteListener(NewCardActivity.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
//            @Override
...
//            }
//        });
//        getDownloadUriTask.addOnCompleteListener(NewCardActivity.this, new OnCompleteListener<Uri>() {
//            @Override
//            public void onComplete(@NonNull Task<Uri> task) {
//                if (task.isSuccessful()){
//                    Uri downloadUri = task.getResult();
//                    Log.i("ERRIMAGE","lkdgjal" + downloadUri.toString());
//                    imageUri  = downloadUri.toString();
//                    mDownloadUriTexView.setText("uri: " + downloadUri);
//                }
//
//
//            }
